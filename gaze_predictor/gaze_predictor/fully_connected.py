...
class FCNetwork(NeuralNetwork):
    ...
    def __init__(self, name, percent_train=0.8, configuration=None):
        ...
        with importlib.resources.path(gaze_predictor.gaze_predictor.data, 'input.npz') as data_path_X:
            with importlib.resources.path(gaze_predictor.gaze_predictor.data, 'output.npz') as data_path_y:
